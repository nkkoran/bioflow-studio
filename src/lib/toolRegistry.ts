...
export const TOOLS: ToolDef[] = [
  // ==================== GWAS ====================
  {
    ...
    params: [
      ...
      { name: 'pheno-name', flag: '--pheno-name', label: 'Phenotype column', type: 'string' },
      { name: 'covar-name', flag: '--covar-name', label: 'Covariate columns', type: 'string', placeholder: 'age,sex,PC1-PC10' },
    ],
  ...
  },
  {
    ...
    params: [
      ...
      { name: 'phenoColList', flag: '--phenoColList', label: 'Phenotype columns', type: 'string' },
      { name: 'covarColList', flag: '--covarColList', label: 'Covariate columns', type: 'string' },
    ],
